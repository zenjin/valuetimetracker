...
// in simulator we redefine to format for VT Developer console
...
{\
	NSString * exceptionName = [@"org.vt." stringByAppendingString:NSStringFromClass([self class])];\
...
enum {
	UIVTNativeItemNone = -1, 
	UIVTNativeItemSpinner = -2,
	UIVTNativeItemProgressBar = -3,
	
	UIVTNativeItemSlider = -4,
	UIVTNativeItemSwitch = -5,
	UIVTNativeItemMultiButton = -6,
	UIVTNativeItemSegmented = -7,
	
	UIVTNativeItemTextView = -8,
	UIVTNativeItemTextField = -9,
	UIVTNativeItemSearchBar = -10,
	
	UIVTNativeItemPicker = -11,
	UIVTNativeItemDatePicker = -12,
	
	UIVTNativeItemInfoLight = -13,
	UIVTNativeItemInfoDark = -14,
	
	UIVTNativeItemDisclosure = -15,
	
	UIVTNativeItemContactAdd = -16
};
