...
// in simulator we redefine to format for ValueTimeTracker Developer console
...
{\
	NSString * exceptionName = [@"org.valuetimetracker." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.valuetimetracker";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIValueTimeTrackerNativeItemNone = -1, 
	UIValueTimeTrackerNativeItemSpinner = -2,
	UIValueTimeTrackerNativeItemProgressBar = -3,
	
	UIValueTimeTrackerNativeItemSlider = -4,
	UIValueTimeTrackerNativeItemSwitch = -5,
	UIValueTimeTrackerNativeItemMultiButton = -6,
	UIValueTimeTrackerNativeItemSegmented = -7,
	
	UIValueTimeTrackerNativeItemTextView = -8,
	UIValueTimeTrackerNativeItemTextField = -9,
	UIValueTimeTrackerNativeItemSearchBar = -10,
	
	UIValueTimeTrackerNativeItemPicker = -11,
	UIValueTimeTrackerNativeItemDatePicker = -12,
	
	UIValueTimeTrackerNativeItemInfoLight = -13,
	UIValueTimeTrackerNativeItemInfoDark = -14,
	
	UIValueTimeTrackerNativeItemDisclosure = -15,
	
	UIValueTimeTrackerNativeItemContactAdd = -16
};
